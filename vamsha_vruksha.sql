...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2026 at 05:31 PM
...
(17, 15, 6, 'Son', '2026-01-09 23:30:24'),
...
--
ALTER TABLE `family_relation`
  MODIFY `Relation_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `person`
  MODIFY `Person_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
