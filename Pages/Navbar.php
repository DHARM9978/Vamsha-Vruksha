...
<body>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div class="user-section" style="margin-bottom:15px"> Welcome, <b><?php echo $_SESSION['user_name']; ?></b>
        ...
        <a href="./Add_Vamsha.php">Add Vamsha</a> <a href="./Add_Admin.php">Add Admin</a> <?php } else { ?>
